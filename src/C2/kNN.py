...
def handwritingClassTest(trainingDir, testDir):
    hwLabels = []
    trainingFileList = os.listdir(trainingDir)           #load the training set
    ...
    testFileList = os.listdir(testDir)        #iterate through the test set
    errorCount = 0.0
